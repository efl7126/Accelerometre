...
#define TEST_MESURE_ACCELERATION
#undef TEST_TABLEAU
#define TEST_BUFFER
...
// ================= SPECIFICATION DE LA CONNECTION RESEAU ================

// Nom du reseau
const char* ssid     = "TP-LINK_E2EB";

// Password du reseau
const char* password = "68128319";
  ...
  int indiceTableau = 0;
    ...
    {  
        ...
        int longueur = 0;
                ...
                #ifdef TEST_MESURE_ACCELERATION
...
{ 
   ...
   {
     Serial.println(" AFFICHAGE DE LA STRUCTURE ");
...
#ifdef TEST_BUFFER      
      afficherBuffer(ts_BufferDonnees,0);
#endif   
  }
